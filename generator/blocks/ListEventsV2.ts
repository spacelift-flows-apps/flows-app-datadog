...
export const ListEventsV2: AppBlock = {
  name: "Get a list of events",
  description: `List endpoint returns events that match an events search query. [Results are paginated similarly to logs](https://docs.datadoghq.com/logs/guide/collect-multiple-logs-with-pagination).  Use this endpoint to see your latest events.`,
  category: "Event",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const urlBase = `${baseUrl}/api/v2/events`;
